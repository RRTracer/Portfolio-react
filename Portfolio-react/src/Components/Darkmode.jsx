  ...
  return (
    <>
      <label className="inline-flex items-center relative">
        <input
          className="peer hidden hover:cursor-pointer focus:cursor-none display-none"
          onChange={() => {
            setDark(!dark);
          }}
          id="toggle"
