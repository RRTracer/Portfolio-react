  ...
  const handleSubmit = async (e) => {
    ...
    return (
        <div className="flex flex-col items-center">
          ...
          <div
              className=" w-fit items-center mt-10 p-4 rounded-lg bg-gradient-to-tr from-blue-300 via-blue-200 to-blue-600 space-y-3 dark:text-white dark:bg-gradient-to-tr dark:from-slate-500 dark:via-slate-800 dark:to-neutral-900">
            <div className="text-3xl font-bold flex justify-center">
              {isRegistered ? (<h1>Sign In Form</h1>) : (<h1>Sign Up Form</h1>)}
            </div>
            <div>
              {isRegistered ? (<form onSubmit={handleSubmit} className="space-y-5 mt-4">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5 mt-4">
                        <div className="flex flex-row space-x-2">
                          ...
                          <div className="flex flex-col">
                            ...
                            <input
                                className="border border-white/60 rounded-lg p-1 hover:border-none hover:ring-1 hover:outline-none hover:ring-offset-transparent hover:ring-sky-300 hover:ring-offset-2  focus:border-none focus:ring-1 focus:outline-none focus:ring-offset-transparent focus:ring-sky-300 focus:ring-offset-2"
                                type="email" id="email" placeholder="your email here ..."
                        ...
                        <div className="flex flex-row space-x-2">
                          ...
                          <div className="flex flex-col">
                            ...
                            <input
                                className="border border-white/60 rounded-lg p-1 hover:border-none hover:ring-1 hover:outline-none hover:ring-offset-transparent hover:ring-sky-300 hover:ring-offset-2  focus:border-none focus:ring-1 focus:outline-none focus:ring-offset-transparent focus:ring-sky-300 focus:ring-offset-2"
                                type="password" id="Confpassword" placeholder="your password"
                        ...
                        <div className="flex flex-col">
                          ...
                          <input
                              className="border border-white/60 rounded-lg p-1 hover:border-none hover:ring-1 hover:outline-none hover:ring-offset-transparent hover:ring-sky-300 hover:ring-offset-2  focus:border-none focus:ring-1 focus:outline-none focus:ring-offset-transparent focus:ring-sky-300 focus:ring-offset-2"
                              type="text" id="enterprise" placeholder="Your company name"
              ...
              <div className="flex justify-center items-center ">
                <p
                    className="mt-6"
                >{isRegistered && "You don't have an account ? "} {!isRegistered && "You already have an account ? "}<a
                    onClick={handleSwapIsRegister}
                    className="text-blue-700  hover:underline"
                    href="">{isRegistered ? ("Sign Up here") : ("Sign In here")}</a></p>
              </div>
            </div>
          </div>
